...
export class Rectangle implements Shape {
  ...
  getProperties(): Property[] {
    return [
      ...
      { type: "string", name: "높이", value: this.height, editable: true },
      { type: "string", name: "너비", value: this.width, editable: true },
      { type: "string", name: "색", value: this.color, editable: true },
    ];
  }
...
export class Ellipse implements Shape {
  ...
  getProperties(): Property[] {
    return [
      ...
      { type: "string", name: "높이", value: this.radiusY * 2, editable: true },
      { type: "string", name: "너비", value: this.radiusX * 2, editable: true },
      { type: "string", name: "색", value: this.color, editable: true },
    ];
  }
...
export class Line implements Shape {
  ...
  getProperties(): Property[] {
    return [
      ...
      { type: "string", name: "길이", value: Math.round(this.length), editable: true },
      { type: "string", name: "선 굵기", value: this.lineWidth, editable: true },
      { type: "string", name: "색", value: this.color, editable: true },
    ];
  }
...
export class TextShape implements Shape {
  ...
  getProperties(): Property[] {
    return [
      ...
      { type: "string", name: "높이", value: this.height, editable: true },
      { type: "string", name: "너비", value: this.width, editable: true },
      // { type: "string", name: "텍스트", value: this.text, editable: true },
      // { type: "string", name: "글자 크기", value: this.fontSize, editable: true },
      // { type: "string", name: "폰트", value: this.fontFamily, editable: true },
      { type: "string", name: "색", value: this.color, editable: true },
    ];
  }
  ...
  setProperties(name: string, value: any): void {
    switch (name) {
      ...
      case "글자 크기":
        ...
        break;
      case "폰트":
        this.fontFamily = value.toString();
        break;
      case "색":
        this.color = value.toString();
        break;
